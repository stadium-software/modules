...
| [Escape Search Box Forwardslashes](https://github.com/stadium-software/utils-escape-search-forwardslashes) | Automatically escape forwardslashes added to DatGrid search boxes | 6 |
...
| Repo | Description | Stadium Versions |
| :--------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------ | :------------ |
| [Add / Remove Class](https://github.com/stadium-software/utils-add-remove-class) | Add, remove or toggle classes on the Control *Classes* property | 6 |
...
| [List to CSV Download](https://github.com/stadium-software/utils-list-to-csv-download) | Converts Lists to CSV files | 6 |
